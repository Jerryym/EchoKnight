...
namespace Echo.Editor.UI
{
	...
	public class DockWidget : VisualElement
	{
		...
		{
			//加载UXML
			VisualTreeAsset uxmlAsset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Echo/Editor/UI/DockWidget/DockWidget.uxml");
			uxmlAsset.CloneTree(this);

			//加载uss
			StyleSheet ussAsset = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Echo/Editor/UI/DockWidget/DockWidget.uss");
